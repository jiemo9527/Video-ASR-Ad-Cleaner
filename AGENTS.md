...
```powershell
scp "E:\Pro_PY\Video-ASR-Ad-Cleaner\install\install.sh" netcup:/www/wwwroot/scanner_web/install/install.sh
ssh netcup 'bash -n /www/wwwroot/scanner_web/install/install.sh'
```
